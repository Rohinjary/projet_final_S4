...
<h1><i class="bi bi-arrow-down-circle me-1"></i>Faire un depot</h1>
<p>Le depot est credite automatiquement sur votre compte.</p>
</div>
...
<div class="mp-card mp-card-body mb-3 stat-success">
...
<div class="form-text">Minimum : 100 Ar - Maximum : 2 000 000 Ar</div>
</div>
<button class="btn btn-success w-100 fw-bold py-2" type="submit"><i class="bi bi-check-circle me-1"></i>Confirmer le depot</button>
</form>
